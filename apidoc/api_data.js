define({ "api": [
  ...
  },
  {
    ...
    "title": "Admin List of call logs",
    "name": "AdminListofCallLogs",
    "group": "Admin___Calls",
    "permission": [
      {
        "name": "Admin"
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "user_id",
            "description": "<p>User id. if this parameter not used, it will show all user's call logs in the application</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
          ...
          },
          {
            ...
            "description": "<p>Filter call logs by participant except user_id above. You can use user fullname or user phone number</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "start_date",
            "description": "<p>Filter call logs by date. filter this by start_date and end_date. use format YYYY-MM-DD</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
    ...
    "filename": "./app/controllers/api/v1/admin/calls_controller.rb",
    "groupTitle": "Admin___Calls",
    "sampleRequest": [
      {
        "url": "https://qisme-stag.qiscus.com/api/v1/admin/calls"
      }
    ]
  },
  {
  ...
  },
  {
    "version": "1.0.0",
    "type": "POST",
    "url": "/api/v1/admin/chat_rooms/delete_all_participants",
    "title": "Delete All Group Participants",
    "description": "<p>Delete all group participants. Then set is_official_chat false when group chat have no participants. Because deleted chat rooms will not be used.</p>",
        ...
        "Parameter": [
          {
            ...
            "description": "<p>Array of integer of qiscus_room_id, e.g: <code>qiscus_room_id[]=1&amp;qiscus_room_id[]=2</code></p>"
          },
          {
            "group": "Parameter",
            "type": "String",
    ...
    "sampleRequest": [
      {
        "url": "https://qisme-stag.qiscus.com/api/v1/admin/chat_rooms/delete_all_participants"
      }
    ]
  },
  {
    ...
    "title": "Add user contacts",
    "name": "AdminAddUserContacts",
    "group": "Admin___Contacts",
    "permission": [
      {
        "name": "Admin"
      }
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "contact_id[]",
            "description": "<p>Array of user_id, e.g: <code>contact_id[]=1&amp;contact_id[]=2</code></p>"
          }
        ]
      }
    },
    "filename": "./app/controllers/api/v1/admin/contacts_controller.rb",
    "groupTitle": "Admin___Contacts",
    "sampleRequest": [
      {
        "url": "https://qisme-stag.qiscus.com/api/v1/admin/contacts"
      }
    ]
  },
  {
  ...
  },
  {
    "version": "1.0.0",
    "type": "get",
    "url": "/api/v1/admin/users/:id/chat_rooms",
    "title": "Show Chat Room by User Id",
    "name": "AdminShowChatRoomByUserId",
    "group": "Admin___User",
    "permission": [
      {
        "name": "Admin"
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>User id in qisme engine</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
          ...
          },
          {
            ...
            "optional": false,
            "field": "limit",
            "description": "<p>Limit data per page</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
    ...
    "sampleRequest": [
      {
        "url": "https://qisme-stag.qiscus.com/api/v1/admin/users/:id/chat_rooms"
      }
    ]
  },
  {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "description": "<p>Country code. It also used at the beginning characters of your phone number. Even though this parameter is optional, it'll be better if you use it to ensure you can communicate with others in the same country.</p>"
          }
        ]
      }
    },
  ...
  },
  {
    "version": "1.0.0",
    "type": "post",
    "url": "/api/v1/chat/broadcast",
    "title": "Update broadcast message status",
    "description": "<p>Update broadcast message status. There are some broadcast status = 'delivered', 'read'. Broadcast message always have extras payload like this. {&quot;is_broadcast&quot;: &quot;true}</p>",
    "name": "UpdateBroadcastStatus",
    "group": "Broadcast",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "qiscus_room_id",
            "description": "<p>Qiscus SDK room id</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "status",
            "description": "<p>Status = 'delivered', 'read'</p>"
          }
        ]
      }
    },
    "filename": "./app/controllers/api/v1/chat/broadcast_controller.rb",
    "groupTitle": "Broadcast",
    "sampleRequest": [
      {
        "url": "https://qisme-stag.qiscus.com/api/v1/chat/broadcast"
      }
    ]
  },
  {
    ...
    "type": "get",
    "url": "/api/v1/calls",
    "title": "List of user call logs",
    "description": "<p>CallLogs</p>",
    "name": "CallLogs",
    "group": "Calls",
    "parameter": {
      "fields": {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": true,
            "field": "bot_user_email",
            "defaultValue": "null",
            "description": "<p>If this parameter set, it will create a group chat with is_official_chat = true</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "type": "get",
    "url": "/api/v2/channel",
    "title": "Channel Deeplink",
    "name": "Channel_Deeplink",
    "description": "<p>Request deeplink from username</p>",
    "group": "Channel",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>The username of the accouunt</p>"
          }
        ]
      }
    },
    "filename": "./app/controllers/api/v2/channel_controller.rb",
    "groupTitle": "Channel",
    "sampleRequest": [
      {
        "url": "https://qisme-stag.qiscus.com/api/v2/channel"
      }
    ]
  },
  {
    "version": "2.0.0",
    "type": "get",
    "url": "/api/v2/channel/username_to_room_id",
    "title": "Username To Room",
    "name": "GetRoomByUsername",
    "group": "Channel",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "username",
            "description": "<p>The username of the channel</p>"
          }
        ]
      }
    },
    ...
    "sampleRequest": [
      {
        "url": "https://qisme-stag.qiscus.com/api/v2/channel/username_to_room_id"
      }
    ]
  },
  {
  ...
  },
  {
    "version": "1.0.0",
    "type": "post",
    "url": "/api/v1/chat/conversations/channel",
    "title": "Create Channel",
    "description": "<p>Create group chat with participants. Channel is a type of room that allows you to have participants with a maximum 5000 participants. The difference between channel and group chat is users or participants cannot get typing, read, and delivered indicators. Please note that if initiator (your access token id) is official, it will be logged as target user id.</p>",
    "name": "CreateChannel",
    "group": "Chat",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "unique_id",
            "defaultValue": "Channel Unique Id",
            "description": "<p>Channel unique id</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
    ...
    "sampleRequest": [
      {
        "url": "https://qisme-stag.qiscus.com/api/v1/chat/conversations/channel"
      }
    ]
  },
  {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "type",
            "description": "<p>Message type <code>text</code>, <code>buttons</code>, <code>card</code>, <code>carousel</code>, or <code>account_linking</code></p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "payload",
            "description": "<p>JSON string for payload, example: { &quot;url&quot;: &quot;http://google.com&quot;, &quot;redirect_url&quot;: &quot;http://google.com/redirect&quot;, &quot;params&quot;: { &quot;user_id&quot;: 1, &quot;topic_id&quot;: 1, &quot;button_text&quot;: &quot;ini button&quot;, &quot;view_title&quot;: &quot;title&quot; } }. For more payload example, please refer to this documentation, https://www.qiscus.com/documentation/rest/latest/comment#post-comment.</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "filename": "./app/controllers/api/v2/contacts_controller.rb",
    "groupTitle": "Contact",
    "sampleRequest": [
      {
        "url": "https://qisme-stag.qiscus.com/api/v2/contacts"
      }
    ]
  },
  {
  ...
  },
  {
    "version": "1.0.0",
    "type": "post",
    "url": "/api/v1/contacts/search_by_all_field",
    "title": "Search User by All Field",
    "description": "<p>Search user by all field such as fullname, phone_number, qiscus, qiscus_email and existing additional_infos</p>",
    "name": "SearchUserByAllField",
    "group": "Contact",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "query",
            "description": "<p>Search query. Support multiple value that separated by space. If query is nil, it'll show all users in application and filtered by &quot;show&quot; parameter used. Example = Heru Bisma</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "show",
            "description": "<p>Possible value is: <code>all</code> to show all user within this application in search results, <code>contact</code> to show only their contact in search results, <code>not_contact</code> to show users thats not in contact in search results. If you don't send any parameter, it will be use previous logic, where <code>only</code> and <code>exclude</code> parameter stills work, otherwise that two parameter will not work.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
    ...
    "sampleRequest": [
      {
        "url": "https://qisme-stag.qiscus.com/api/v1/contacts/search_by_all_field"
      }
    ]
  },
  {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "contact[]",
            "description": "<p>Array of object of contacts with phone number and contact name, for instance: <code>contact:[{&quot;phone_number&quot;:&quot;+62832421&quot;,&quot;contact_name&quot;:&quot;hello&quot;},{&quot;phone_number&quot;:&quot;+62832424&quot;,&quot;contact_name&quot;:&quot;world&quot;}]</code></p>"
          }
        ]
      }
    },
    "filename": "./app/controllers/api/v2/contacts/sync_controller.rb",
    "groupTitle": "Contact",
    "sampleRequest": [
      {
        "url": "https://qisme-stag.qiscus.com/api/v1/contacts/sync"
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "show_media_list_as",
            "description": "<p>You can show media as an object (will return first media), or as an array (will retun array of media).</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "type": "Text",
            "optional": false,
            "field": "user[additional_infos]",
            "description": "<p>[key] You can fill anything in [key]</p>"
          }
        ]
      }
    },
  ...
  },
  {
    "version": "1.0.0",
    "type": "post",
    "url": "/api/v1/rest/conversations/create_or_join_room_with_unique_id",
    "title": "Create or join room with unique id",
    "description": "<p>If room with predefined unique id is not exist then it will create a new one. Otherwise, if room with predefined unique id is already exist, it will return that room and add user_id as a participant. Room created using unique_id will have flag is_public_chat = true.</p>",
    "name": "CreateOrJoinRoomWithUniqueId",
    "group": "Rest_API",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "server_key",
            "description": "<p>Application server key</p>"
          },
          {
            "group": "Parameter",
            "type": "Array",
          ...
          },
          {
            ...
            "optional": false,
            "field": "unique_id",
            "description": "<p>Unique id. You can define unique_id by yourself</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
    ...
    "sampleRequest": [
      {
        "url": "https://qisme-stag.qiscus.com/api/v1/rest/conversations/create_or_join_room_with_unique_id"
      }
    ]
  },
  {
  ...
  },
  {
    "version": "1.0.0",
    "type": "post",
    "url": "/api/v1/rest/auth_email_nonce",
    "title": "Login or Register using Server Key with nonce",
    "description": "<p>Register user if not exist, otherwise only return access key</p>",
    "name": "LoginOrRegisterEmailNonce",
    "group": "Rest_API",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "user[fullname]",
            "description": "<p>Valid fullname to be register or sign in</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "user[avatar_url]",
            "description": "<p>Valid avatar_url to be register or sign in. Default avatar_url = https://d1edrlpyc25xu0.cloudfront.net/image/upload/t5XWp2PBRt/1510641299-default_user_avatar.png</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
    ...
    "filename": "./app/controllers/api/v1/rest/auth_email_nonce_controller.rb",
    "groupTitle": "Rest_API",
    "sampleRequest": [
      {
        "url": "https://qisme-stag.qiscus.com/api/v1/rest/auth_email_nonce"
      }
    ]
  },
  {
    "version": "1.0.0",
    "type": "post",
    "url": "/api/v1/rest/conversations/post_system_event_message",
    "title": "Post system event message",
    "description": "<p>Post system event message without using access_token. This event message type is custom.</p>",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "qiscus_room_id",
            "description": "<p>Valid qiscus room id</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "optional": true,
            "field": "extras",
            "description": "<p>Optional JSON string</p>"
          }
        ]
      }
    },
    ...
    "sampleRequest": [
      {
        "url": "https://qisme-stag.qiscus.com/api/v1/rest/conversations/post_system_event_message"
      }
    ]
  },
  {
    "version": "1.0.0",
    "type": "post",
    "url": "/api/v1/rest/me/update_profile",
    "title": "Update Profile",
    "name": "UpdateProfile",
    "group": "Rest_API",
    "description": "<p>Before updating user's email or phone number, system will check whether there are no another user who have same email/phone number except current user. Why this should be considered? For example there are 2 user: A and B registered in same application (id). A register using phone number, let say 123. B register using email, let say b@mail.com.</p> <p>Now, image if we don't check anything about data existense and let A to update his profile email to b@mail.com and let B to update their phone number to 123 (actually it can't be done because of db validation). It will be result strange behaviour in login method, since it just using one parameter, either email or phone number.</p> <p>Now, A have: 123, b@mail.com and B have: 123, b@mail.com It's the same data, and please forget about how it can be B know A's phone number or how it can A know B's email? The point is, it will led system have duplicate data (even it can't be done because of database validation). As we expected, when B try to login he will get authentication using id A. And when A try to login it will be A.</p>",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "app_id",
            "description": "<p>Application app_id</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
    ...
    "filename": "./app/controllers/api/v1/rest/me_controller.rb",
    "groupTitle": "Rest_API",
    "sampleRequest": [
      {
        "url": "https://qisme-stag.qiscus.com/api/v1/rest/me/update_profile"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "type": "get",
    "url": "/api/v1/users/",
    "title": "Show Detail Multiple Users",
    "description": "<p>Show detail user using multipe user_id</p>",
    "name": "ShowDetailMultipleUser",
    "group": "User",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "user_id[]",
            "description": "<p>Array of user_id</p>"
          }
        ]
      }
    },
    ...
    "sampleRequest": [
      {
        "url": "https://qisme-stag.qiscus.com/api/v1/users/"
      }
    ]
  },
  {
    ...
    "type": "get",
    "url": "/api/v1/users/:id",
    "title": "Show Detail Single User",
    "description": "<p>Show detail user using single user_id</p>",
    "name": "ShowDetailSingleUser",
    "group": "User",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>Where id is user_id</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "group": "_media_asyrof_Game1_backend_ruby_kiwari_engine_docs_apidoc_main_js",
    "groupTitle": "_media_asyrof_Game1_backend_ruby_kiwari_engine_docs_apidoc_main_js",
    "name": ""
  }
] });
