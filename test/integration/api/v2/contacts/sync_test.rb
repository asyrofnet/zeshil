...
class API::V2::Contacts::SyncTest< ActionDispatch::IntegrationTest
  ...
  #changed the flow because now use perform later.
  test "user1 attempt to sync" do
    ...
    ContactCreateJob.expects(:perform_later)
    ...
    #assertion below is deprecated because syncing is now moved to background
