class Dashboard::SuperAdmin::Application::AuthSessionsController < SuperAdminController
  ...
  # get /dashboard/super_admin/application/2/users/4/auth_sessions/delete_all
  def delete_all
    begin
