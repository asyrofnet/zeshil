...
class Dashboard::SuperAdmin::Application::UsersController < SuperAdminController
  ...
  def show
    begin
      @user = ::User.find_by(id: params[:id], application_id: params[:application_id])
  ...
  # for update user
  # post /dashboard/super_admin/application/2/users/4
  def update
    begin
      @user = ::User.find_by(id: params[:id], application_id: params[:application_id])
  ...
  # get /dashboard/super_admin/application/2/users/4/delete
  def delete
    begin
      @user = ::User.find_by(id: params[:id], application_id: params[:application_id])
      application = ::Application.find(params[:application_id])
      ...
      ActiveRecord::Base.transaction do
        ...
        if chat_rooms.nil?
          ...
          chat_rooms.each do |chat_room|
            ...
            if group_admin_count == 0 && chat_room.chat_users.count > 0
  ...
  def create
    begin
      ...
      ActiveRecord::Base.transaction do
        ...
        # If connected to coaching module. It can't add Official Account roles
        application = ::Application.find(params[:application_id])
        if application.is_coaching_module_connected
      ...
      redirect_to "/dashboard/super_admin/application/#{application.id}/users/#{user.id}"
  ...
  # post /dashboard/super_admin/application/2/users/4/update_features
  def update_features
    begin
      @user = ::User.find_by(id: params[:id], application_id: params[:application_id])
      user_params = params.permit!
  ...
  # post /dashboard/super_admin/application/2/users/4/create_room_with_unique_id
    ...
    begin
      ...
      ActiveRecord::Base.transaction do
        ...
        if !chat_room.nil?
          ...
          redirect_to "/dashboard/super_admin/application/#{application.id}/users/#{@user.id}/activity" and return
        end
      ...
      redirect_to "/dashboard/super_admin/application/#{application.id}/users/#{@user.id}/activity"
