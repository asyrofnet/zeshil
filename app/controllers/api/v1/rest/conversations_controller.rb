  ...
  def create_room_with_unique_id
    begin
      ...
      ActiveRecord::Base.transaction do
        ...
        if !chat_room.nil?
          raise InputError.new('Public chat room already exist.')
        end
    ...
    begin
      ...
      ActiveRecord::Base.transaction do
        ...
        if unique_id.nil? || unique_id == ""
          raise InputError.new("Unique id can't be empty.")
        end
            ...
            error: {
              message: "Invalid server key."
				...
				if qiscus_room_id.nil? || qiscus_room_id == ""
					raise InputError.new("qiscus_room_id cannot be empty.")
				end
				...
				if chat_room.nil?
					raise InputError.new("chat_room not found")
				end
